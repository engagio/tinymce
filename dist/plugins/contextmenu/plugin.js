...
var contextmenu = (function () {
  ...
  var $_1izlst9ujdmdg0ml = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_5c3p2c9tjdmdg0mi.getContextMenu(editor);
  ...
  var $_fcmyn29xjdmdg0mr = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_5c3p2c9tjdmdg0mi.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_fcmyn29xjdmdg0mr.show(editor, $_1izlst9ujdmdg0ml.getPos(editor, e), visibleState, menu);
    });
  };
  var $_1kkb49sjdmdg0mg = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_1kkb49sjdmdg0mg.setup(editor, visibleState, menu);
    return $_f1czdb9rjdmdg0md.get(visibleState);
  });
  function Plugin () {
  }
