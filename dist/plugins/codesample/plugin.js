...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_1vogkl9fjdmdg0k8.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_8rv6om9bjdmdg0iz.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_47re1j9djdmdg0j1.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_61po609gjdmdg0ka = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_asxrub9ajdmdg0ix = {
    open: function (editor) {
      var minWidth = $_8rv6om9bjdmdg0iz.getDialogMinWidth(editor);
      var minHeight = $_8rv6om9bjdmdg0iz.getDialogMinHeight(editor);
      var currentLanguage = $_61po609gjdmdg0ka.getCurrentLanguage(editor);
      var currentLanguages = $_61po609gjdmdg0ka.getLanguages(editor);
      var currentCode = $_47re1j9djdmdg0j1.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_47re1j9djdmdg0j1.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_1vogkl9fjdmdg0k8.isCodeSample(node)) {
        $_asxrub9ajdmdg0ix.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_24esnx99jdmdg0iw = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_1vogkl9fjdmdg0k8.trimArg($_1vogkl9fjdmdg0k8.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_1vogkl9fjdmdg0k8.trimArg($_1vogkl9fjdmdg0k8.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_5b2onq9hjdmdg0kc = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_8rv6om9bjdmdg0iz.getContentCss(editor);
  ...
  var $_13skmw9ijdmdg0ke = { loadCss: loadCss };
  ...
  var $_99072s9jjdmdg0kh = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_5b2onq9hjdmdg0kc.setup(editor);
    $_99072s9jjdmdg0kh.register(editor);
    $_24esnx99jdmdg0iw.register(editor);
    editor.on('init', function () {
      $_13skmw9ijdmdg0ke.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_1vogkl9fjdmdg0k8.isCodeSample(ev.target)) {
        $_asxrub9ajdmdg0ix.open(editor);
      }
    });
  });
