...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_7ninyu84jdmdg0ec.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_7ninyu84jdmdg0ec.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_7ninyu84jdmdg0ec.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_7ninyu84jdmdg0ec.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_7ninyu84jdmdg0ec.getAutoResizeBottomMargin(editor);
    ...
    if ($_7ninyu84jdmdg0ec.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_ducxvg81jdmdg0e7.resize(editor, oldSize);
    });
  };
  var $_bvyi4n80jdmdg0e5 = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_bvyi4n80jdmdg0e5.register(editor, oldSize);
      $_ducxvg81jdmdg0e7.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
