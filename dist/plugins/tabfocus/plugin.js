...
var tabfocus = (function () {
  ...
  var $_3eobwajdjdmdg1zy = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_3eobwajdjdmdg1zy.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_98hpyfj6jdmdg1zs = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_98hpyfj6jdmdg1zs.setup(editor);
  });
  function Plugin () {
  }
