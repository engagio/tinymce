...
var emoticons = (function () {
  ...
  var $_avzx39a9jdmdg0nu = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_avzx39a9jdmdg0nu.getHtml(pluginUrl);
  ...
  var $_96gwcja8jdmdg0ns = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_96gwcja8jdmdg0ns.register(editor, pluginUrl);
  });
  function Plugin () {
  }
