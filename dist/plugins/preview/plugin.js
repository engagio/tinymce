...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_77xcovhxjdmdg1tb.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_77xcovhxjdmdg1tb.getPreviewDialogWidth(editor);
    var dialogHeight = $_77xcovhxjdmdg1tb.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_6xxzdwhyjdmdg1td.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_5tsai3hvjdmdg1t8 = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_5tsai3hvjdmdg1t8.open(editor);
    });
  };
  var $_cemptdhujdmdg1t6 = { register: register };
  ...
  var $_ggbg1li0jdmdg1tg = { register: register$1 };

  PluginManager.add('preview', function (editor) {
    $_cemptdhujdmdg1t6.register(editor);
    $_ggbg1li0jdmdg1tg.register(editor);
  });
  function Plugin () {
  }
