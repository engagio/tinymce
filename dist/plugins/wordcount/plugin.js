...
var wordcount = (function () {
  ...
  var $_eqo8x9rsjdmdg480 = {
    each: each,
    map: map
  };

  var SETS$1 = $_12qu7drqjdmdg47v.SETS;
  var OTHER = $_12qu7drqjdmdg47v.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_eqo8x9rsjdmdg480.map(string.split(''), memoized);
  };
  var $_ape6hdrrjdmdg47y = { classify: classify };

  var ci = $_12qu7drqjdmdg47v.characterIndices;
  ...
  var $_aa3kymrtjdmdg482 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_12qu7drqjdmdg47v.EMPTY_STRING;
  var WHITESPACE$1 = $_12qu7drqjdmdg47v.WHITESPACE;
  var PUNCTUATION$1 = $_12qu7drqjdmdg47v.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_ape6hdrrjdmdg47y.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_aa3kymrtjdmdg482.isWordBoundary(map, i)) {
  ...
  var $_7pu0agrpjdmdg47s = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_7pu0agrpjdmdg47s.getWords(getTextContent(editor)).length;
  };
  var $_eoe0iqrojdmdg47r = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_eoe0iqrojdmdg47r.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_e23dornjdmdg47q = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_eoe0iqrojdmdg47r.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_8vryp9rujdmdg485 = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_8vryp9rujdmdg485.setup(editor);
    return $_e23dornjdmdg47q.get(editor);
  });
  function Plugin () {
  }
