...
var toc = (function () {
  ...
  var $_4n8n2kqmjdmdg43a = { create: create };

  var tocId = $_4n8n2kqmjdmdg43a.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_1a3lobqljdmdg437.getTocClass(editor);
    var headerTag = $_1a3lobqljdmdg437.getTocHeader(editor);
    var selector = generateSelector($_1a3lobqljdmdg437.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_1a3lobqljdmdg437.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_1a3lobqljdmdg437.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_7o5o0qhjdmdg42x.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_7o5o0qhjdmdg42x.updateToc(editor);
    });
  };
  var $_5i2tqbqgjdmdg42s = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_1a3lobqljdmdg437.getTocClass(editor);
  ...
  var $_3q1tpbqnjdmdg43c = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_7o5o0qhjdmdg42x.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_1a3lobqljdmdg437.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_7960irqojdmdg43f = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_5i2tqbqgjdmdg42s.register(editor);
    $_7960irqojdmdg43f.register(editor);
    $_3q1tpbqnjdmdg43c.setup(editor);
  });
  function Plugin () {
  }
