...
var help = (function () {
  ...
  var never$1 = $_fadez6aijdmdg0p2.never;
  var always$1 = $_fadez6aijdmdg0p2.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_fadez6aijdmdg0p2.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_83fozpakjdmdg0p5 = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_6hh2vhagjdmdg0om.map($_83fozpakjdmdg0p5.shortcuts, function (shortcut) {
  ...
  var $_5fl66iafjdmdg0og = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_1hhcl9apjdmdg0po.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_1hhcl9apjdmdg0po.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_1hhcl9apjdmdg0po.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_1hhcl9apjdmdg0po.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_3hgdvwaqjdmdg0pp.head(str).bind(function (head) {
      return $_3hgdvwaqjdmdg0pp.tail(str).map(function (tail) {
  ...
  var $_95gzcvarjdmdg0pr = { urls: urls };

  var makeLink = $_fadez6aijdmdg0p2.curry($_fe6yc8aojdmdg0pk.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_6hh2vhagjdmdg0om.find($_95gzcvarjdmdg0pr.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_3xyxt8anjdmdg0ph.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_6hh2vhagjdmdg0om.filter(keys, $_fadez6aijdmdg0p2.not($_fadez6aijdmdg0p2.curry($_6hh2vhagjdmdg0om.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_6hh2vhagjdmdg0om.map(pluginKeys, function (key) {
  ...
  var $_2565mmamjdmdg0p8 = { makeTab: makeTab$1 };
  ...
  var $_5rsnbbasjdmdg0pt = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_5fl66iafjdmdg0og.makeTab(),
          $_2565mmamjdmdg0p8.makeTab(editor)
        ],
        buttons: $_5rsnbbasjdmdg0pt.makeRow(),
  ...
  var $_8v08cqaejdmdg0oe = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_8v08cqaejdmdg0oe.open(editor, pluginUrl));
  };
  var $_g7oh1qadjdmdg0oc = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_8v08cqaejdmdg0oe.open(editor, pluginUrl)
    });
  ...
  var $_ftv0kraujdmdg0pv = { register: register$1 };

  PluginManager.add('help', function (editor, pluginUrl) {
    $_ftv0kraujdmdg0pv.register(editor, pluginUrl);
    $_g7oh1qadjdmdg0oc.register(editor, pluginUrl);
