...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_84tnt7dxjdmdg19i.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_84tnt7dxjdmdg19i.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_84tnt7dxjdmdg19i.getSelectorConverter(editor)) {
      selectorConverter = $_84tnt7dxjdmdg19i.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_84tnt7dxjdmdg19i.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_84tnt7dxjdmdg19i.getCssGroups(editor));
      ...
      if (!$_84tnt7dxjdmdg19i.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_84tnt7dxjdmdg19i.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_1x0kiodsjdmdg198.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_32tsc6drjdmdg195 = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_1x0kiodsjdmdg198.setup(editor);
    return $_32tsc6drjdmdg195.get(editor);
  });
  function Plugin () {
  }
