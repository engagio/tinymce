...
var inlite = (function () {
  ...
  var $_785vcp166jdmdg7uv = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_7zlyxh16ajdmdg7v1.fromClientRect(clientRect)) : null;
  };
  var $_fo4ocb169jdmdg7uz = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          return $_exchmj168jdmdg7uy.result(predicateIds[i].id, $_fo4ocb169jdmdg7uz.getElementRect(editor, element));
        }
      }
      return null;
    };
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_exchmj168jdmdg7uy.result(predicateIds[x].id, $_fo4ocb169jdmdg7uz.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        return $_exchmj168jdmdg7uy.result(id, $_fo4ocb169jdmdg7uz.getSelectionRect(editor));
      }
      return null;
    };
  };
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_3rkf4o16jjdmdg7vc.isArray(value)) {
      return value;
    } else if ($_3rkf4o16jjdmdg7vc.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_3rkf4o16jjdmdg7vc.isBoolean(value)) {
  ...
  var $_5dl43g16ijdmdg7vb = {
    getStringOr: getByTypeOr($_3rkf4o16jjdmdg7vc.isString),
    getBoolOr: getByTypeOr($_3rkf4o16jjdmdg7vc.isBoolean),
    getNumberOr: getByTypeOr($_3rkf4o16jjdmdg7vc.isNumber),
    getHandlerOr: getByTypeOr($_3rkf4o16jjdmdg7vc.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_3rkf4o16jjdmdg7vc.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_7zlyxh16ajdmdg7v1.toClientRect(targetRect),
        contentAreaRect: $_7zlyxh16ajdmdg7v1.toClientRect(contentAreaRect),
        panelRect: $_7zlyxh16ajdmdg7v1.toClientRect(panelRect)
      });
      return $_7zlyxh16ajdmdg7v1.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_5dl43g16ijdmdg7vb.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_5dl43g16ijdmdg7vb.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_5dl43g16ijdmdg7vb.getHandlerOr(editor, 'inline_toolbar_position_handler', $_cq8idq16kjdmdg7ve.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_7u5jzu16fjdmdg7v7.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_14jzly16gjdmdg7v8.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_14jzly16gjdmdg7v8.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_8qjux916ejdmdg7v6 = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_785vcp166jdmdg7uv.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_en6die16bjdmdg7v3.fromContextToolbars(toolbars);
    result = $_exchmj168jdmdg7uy.match(editor, [
      $_ad7lcw167jdmdg7ux.element(elements[0], contextToolbarsPredicateIds),
      $_fg34uj16djdmdg7v4.textSelection('text'),
      $_fg34uj16djdmdg7v4.emptyTextBlock(elements, 'insert'),
      $_ad7lcw167jdmdg7ux.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_exchmj168jdmdg7uy.match(editor, [$_fg34uj16djdmdg7v4.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_8qjux916ejdmdg7v6.load(editor, function () {
  ...
  var $_fi65xs162jdmdg7ur = { renderUI: renderUI };
  ...
  var never$1 = $_6f2mw816pjdmdg7vu.never;
  var always$1 = $_6f2mw816pjdmdg7vu.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_6f2mw816pjdmdg7vu.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_ei9uec16wjdmdg7ww.parseBox(settings.border);
      self.paddingBox = $_ei9uec16wjdmdg7ww.parseBox(settings.padding);
      self.marginBox = $_ei9uec16wjdmdg7ww.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_ei9uec16wjdmdg7ww.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_ei9uec16wjdmdg7ww.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_ei9uec16wjdmdg7ww.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_efev5d173jdmdg7xf.remove(this);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_6f045q16njdmdg7vm.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_6f045q16njdmdg7vm.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_ei9uec16wjdmdg7ww.parseBox(self.settings.border);
          ...
          self.borderBox = $_ei9uec16wjdmdg7ww.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_fi65xs162jdmdg7ur.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_8a46v8161jdmdg7ud = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_67ojmf17njdmdg7zl.resolve(name, scope);
  };
  ...
  var $_aigi3k17mjdmdg7zh = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_aigi3k17mjdmdg7zh.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_1488j617kjdmdg7zc = { blobToBase64: blobToBase64 };
  ...
  var $_cy6ac617qjdmdg7zq = { pickFile: pickFile };
  ...
  var $_9mslq917sjdmdg7zx = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_6jamgq17ujdmdg801.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_6jamgq17ujdmdg801.resolve(dom, bookmark));
  };
  ...
  var $_8oyxy317tjdmdg7zz = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_9mslq917sjdmdg7zx.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_8oyxy317tjdmdg7zz.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_18ejpd17rjdmdg7zt.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_cy6ac617qjdmdg7zq.pickFile().then(function (files) {
          var blob = files[0];
          $_1488j617kjdmdg7zc.blobToBase64(blob).then(function (base64) {
            $_18ejpd17rjdmdg7zt.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_18ejpd17rjdmdg7zt.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_8xfw2d17jjdmdg7za = { addToEditor: addToEditor };
  ...
  var $_c5n04l17yjdmdg80p = { getUiContainerDelta: getUiContainerDelta };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_3xo1y5180jdmdg815.isAbsolute(href) && $_3xo1y5180jdmdg815.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_18ejpd17rjdmdg7zt.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_18ejpd17rjdmdg7zt.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_etrd2717zjdmdg80z = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_3rkf4o16jjdmdg7vc.isArray(items)) {
      return items;
    } else if ($_3rkf4o16jjdmdg7vc.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
  ...
  var $_5nce0s181jdmdg817 = { create: create$2 };

  function Panel$1 () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_5nce0s181jdmdg817.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_5nce0s181jdmdg817.create(editor, 'text', $_14jzly16gjdmdg7v8.getTextSelectionToolbarItems(editor)),
        $_5nce0s181jdmdg817.create(editor, 'insert', $_14jzly16gjdmdg7v8.getInsertToolbarItems(editor)),
        $_etrd2717zjdmdg80z.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_14jzly16gjdmdg7v8.getPositionHandler(editor);
      contentAreaRect = $_fo4ocb169jdmdg7uz.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_cq8idq16kjdmdg7ve.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_cq8idq16kjdmdg7ve.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_c5n04l17yjdmdg80p.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_cq8idq16kjdmdg7ve.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_fo4ocb169jdmdg7uz.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_cq8idq16kjdmdg7ve.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_cq8idq16kjdmdg7ve.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_7u5jzu16fjdmdg7v7.fireBeforeRenderUI(editor);
  ...
  var $_d4q9rz18ojdmdg84e = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_6f2mw816pjdmdg7vu.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_g7pejy18pjdmdg84h = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_dzmsyb18tjdmdg84v = { cached: cached };

  var $_f0lxgo18vjdmdg84y = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_f0lxgo18vjdmdg84y.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_f0lxgo18vjdmdg84y.ELEMENT);
  var isText = isType$1($_f0lxgo18vjdmdg84y.TEXT);
  var isDocument = isType$1($_f0lxgo18vjdmdg84y.DOCUMENT);
  var $_5f03c18ujdmdg84w = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_5f03c18ujdmdg84w.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_dzmsyb18tjdmdg84v.cached(function () {
    return getBody($_g7pejy18pjdmdg84h.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_g7pejy18pjdmdg84h.fromDom(body);
  };
  var $_g09vxv18sjdmdg84r = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_6f045q16njdmdg7vm.each(fields, function (name, i) {
        struct[name] = $_6f2mw816pjdmdg7vu.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_bn6vbe18xjdmdg85h.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_6f045q16njdmdg7vm.each(array, function (a) {
      if (!$_bn6vbe18xjdmdg85h.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_6f045q16njdmdg7vm.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_89rg08192jdmdg862.validateStrArr('required', required);
    $_89rg08192jdmdg862.validateStrArr('optional', optional);
    $_89rg08192jdmdg862.checkDupes(everything);
    return function (obj) {
      var keys = $_uqpd8191jdmdg85y.keys(obj);
      var allReqd = $_6f045q16njdmdg7vm.forall(required, function (req) {
        return $_6f045q16njdmdg7vm.contains(keys, req);
      });
      if (!allReqd)
        $_89rg08192jdmdg862.reqMessage(required, keys);
      var unsupported = $_6f045q16njdmdg7vm.filter(keys, function (key) {
        return !$_6f045q16njdmdg7vm.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_89rg08192jdmdg862.unsuppMessage(unsupported);
      var r = {};
      $_6f045q16njdmdg7vm.each(required, function (req) {
        r[req] = $_6f2mw816pjdmdg7vu.constant(obj[req]);
      });
      $_6f045q16njdmdg7vm.each(optional, function (opt) {
        r[opt] = $_6f2mw816pjdmdg7vu.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_fon1ds18yjdmdg85j = {
    immutable: Immutable,
  ...
  var $_ag2547193jdmdg864 = { toArray: toArray };

  var node = function () {
    var f = $_aigi3k17mjdmdg7zh.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_e1mrr199jdmdg86w.unknown()
    });
  };
  ...
  var $_5hy30u198jdmdg86t = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_6f2mw816pjdmdg7vu.constant(edge),
    chrome: $_6f2mw816pjdmdg7vu.constant(chrome),
    ie: $_6f2mw816pjdmdg7vu.constant(ie),
    opera: $_6f2mw816pjdmdg7vu.constant(opera),
    firefox: $_6f2mw816pjdmdg7vu.constant(firefox),
    safari: $_6f2mw816pjdmdg7vu.constant(safari)
  };
  ...
  var $_2uwcm919ajdmdg86z = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_6f2mw816pjdmdg7vu.constant(windows$1),
    ios: $_6f2mw816pjdmdg7vu.constant(ios),
    android: $_6f2mw816pjdmdg7vu.constant(android),
    linux: $_6f2mw816pjdmdg7vu.constant(linux),
    osx: $_6f2mw816pjdmdg7vu.constant(osx),
    solaris: $_6f2mw816pjdmdg7vu.constant(solaris),
    freebsd: $_6f2mw816pjdmdg7vu.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_6f2mw816pjdmdg7vu.constant(isiPad),
      isiPhone: $_6f2mw816pjdmdg7vu.constant(isiPhone),
      isTablet: $_6f2mw816pjdmdg7vu.constant(isTablet),
      isPhone: $_6f2mw816pjdmdg7vu.constant(isPhone),
      isTouch: $_6f2mw816pjdmdg7vu.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_6f2mw816pjdmdg7vu.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_6f045q16njdmdg7vm.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_e1mrr199jdmdg86w.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_e1mrr199jdmdg86w.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_c4otft19fjdmdg87k.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_c4otft19fjdmdg87k.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_c4otft19fjdmdg87k.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_c4otft19fjdmdg87k.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_81qlgg19gjdmdg87l.head(str).bind(function (head) {
      return $_81qlgg19gjdmdg87l.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_595te619ejdmdg87g.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_595te619ejdmdg87g.contains(uastring, 'edge/') && $_595te619ejdmdg87g.contains(uastring, 'chrome') && $_595te619ejdmdg87g.contains(uastring, 'safari') && $_595te619ejdmdg87g.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_595te619ejdmdg87g.contains(uastring, 'chrome') && !$_595te619ejdmdg87g.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_595te619ejdmdg87g.contains(uastring, 'msie') || $_595te619ejdmdg87g.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_595te619ejdmdg87g.contains(uastring, 'safari') || $_595te619ejdmdg87g.contains(uastring, 'mobile/')) && $_595te619ejdmdg87g.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_595te619ejdmdg87g.contains(uastring, 'iphone') || $_595te619ejdmdg87g.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_4651sn19djdmdg87a = {
    browsers: $_6f2mw816pjdmdg7vu.constant(browsers),
    oses: $_6f2mw816pjdmdg7vu.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_4651sn19djdmdg87a.browsers();
    var oses = $_4651sn19djdmdg87a.oses();
    var browser = $_3l458x19cjdmdg876.detectBrowser(browsers, userAgent).fold($_5hy30u198jdmdg86t.unknown, $_5hy30u198jdmdg86t.nu);
    var os = $_3l458x19cjdmdg876.detectOs(oses, userAgent).fold($_2uwcm919ajdmdg86z.unknown, $_2uwcm919ajdmdg86z.nu);
  ...
  var $_7xaywa197jdmdg86r = { detect: detect$2 };

  var detect$3 = $_dzmsyb18tjdmdg84v.cached(function () {
    var userAgent = navigator.userAgent;
    return $_7xaywa197jdmdg86r.detect(userAgent);
  });
  var $_5m6p5k196jdmdg86m = { detect: detect$3 };

  var ELEMENT = $_f0lxgo18vjdmdg84y.ELEMENT;
  var DOCUMENT = $_f0lxgo18vjdmdg84y.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_6f045q16njdmdg7vm.map(base.querySelectorAll(selector), $_g7pejy18pjdmdg84h.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_g7pejy18pjdmdg84h.fromDom);
  };
  var $_6qepmq19hjdmdg87n = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_6f045q16njdmdg7vm.exists(elements, $_6f2mw816pjdmdg7vu.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_8s0boh195jdmdg86k.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_5m6p5k196jdmdg86m.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_fq1dm1194jdmdg866 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_6qepmq19hjdmdg87n.is
  };

  var owner = function (element) {
    return $_g7pejy18pjdmdg84h.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_g7pejy18pjdmdg84h.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_g7pejy18pjdmdg84h.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_g7pejy18pjdmdg84h.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_6f045q16njdmdg7vm.findIndex(kin, function (elem) {
        return $_fq1dm1194jdmdg866.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_bn6vbe18xjdmdg85h.isFunction(isRoot) ? isRoot : $_6f2mw816pjdmdg7vu.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_g7pejy18pjdmdg84h.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_6f045q16njdmdg7vm.filter(elements, function (x) {
        return !$_fq1dm1194jdmdg866.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_g7pejy18pjdmdg84h.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_g7pejy18pjdmdg84h.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_g7pejy18pjdmdg84h.fromDom);
  };
  var prevSiblings = function (element) {
    return $_6f045q16njdmdg7vm.reverse($_ag2547193jdmdg864.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_ag2547193jdmdg864.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_6f045q16njdmdg7vm.map(dom.childNodes, $_g7pejy18pjdmdg84h.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_g7pejy18pjdmdg84h.fromDom);
  };
  ...
  var spot = $_fon1ds18yjdmdg85j.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_577ogc18wjdmdg851 = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_g09vxv18sjdmdg84r.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_6f045q16njdmdg7vm.filter($_577ogc18wjdmdg851.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_6f045q16njdmdg7vm.filter($_577ogc18wjdmdg851.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_6f045q16njdmdg7vm.filter($_577ogc18wjdmdg851.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_6f045q16njdmdg7vm.each($_577ogc18wjdmdg851.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_6qepmq19hjdmdg87n.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_1aajql18rjdmdg84o.ancestors(scope, function (e) {
      return $_6qepmq19hjdmdg87n.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_1aajql18rjdmdg84o.siblings(scope, function (e) {
      return $_6qepmq19hjdmdg87n.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_1aajql18rjdmdg84o.children(scope, function (e) {
      return $_6qepmq19hjdmdg87n.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_6qepmq19hjdmdg87n.all(selector, scope);
  };
  var $_1sxtnk18qjdmdg84m = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_6f045q16njdmdg7vm.map($_1sxtnk18qjdmdg84m.descendants($_g7pejy18pjdmdg84h.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_d4q9rz18ojdmdg84e.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$3('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_6f2mw816pjdmdg7vu.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_6f045q16njdmdg7vm.map($_6f045q16njdmdg7vm.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_6f045q16njdmdg7vm.map($_6f045q16njdmdg7vm.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_6f045q16njdmdg7vm.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_f2uiar18njdmdg845 = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_6f2mw816pjdmdg7vu.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_6f045q16njdmdg7vm.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_6f045q16njdmdg7vm.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_6f045q16njdmdg7vm.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_6f045q16njdmdg7vm.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_6f045q16njdmdg7vm.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_f2uiar18njdmdg845.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_bn6vbe18xjdmdg85h.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_g09vxv18sjdmdg84r.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_g7pejy18pjdmdg84h.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_g7pejy18pjdmdg84h.fromDom(element.parentNode), function (x) {
      return !$_fq1dm1194jdmdg866.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_6f045q16njdmdg7vm.find(scope.dom().childNodes, $_6f2mw816pjdmdg7vu.compose(predicate, $_g7pejy18pjdmdg84h.fromDom));
    return result.map($_g7pejy18pjdmdg84h.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_g7pejy18pjdmdg84h.fromDom(element.childNodes[i])))
          return Option.some($_g7pejy18pjdmdg84h.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_6qepmq19hjdmdg87n.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_2p4xbf19njdmdg88m.ancestor(scope, function (e) {
      return $_6qepmq19hjdmdg87n.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_2p4xbf19njdmdg88m.sibling(scope, function (e) {
      return $_6qepmq19hjdmdg87n.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_2p4xbf19njdmdg88m.child(scope, function (e) {
      return $_6qepmq19hjdmdg87n.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_6qepmq19hjdmdg87n.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_6qepmq19hjdmdg87n.is, ancestor$1, scope, selector, isRoot);
  };
  var $_ad7v9819mjdmdg88c = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_6j9w4v19qjdmdg893.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_6j9w4v19qjdmdg893.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_6j9w4v19qjdmdg893.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_6j9w4v19qjdmdg893.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_6j9w4v19qjdmdg893.postRenderFormat(editor, name)
      });
    });
  };
  var $_a483nn19pjdmdg890 = { register: register };
  ...
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return Option.from(elm).map($_g7pejy18pjdmdg84h.fromDom).filter($_5f03c18ujdmdg84w.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_7006y219sjdmdg89b = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_6f2mw816pjdmdg7vu.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_7006y219sjdmdg89b.getFontFamily(editor.getBody(), e.element);
  ...
  var $_6abs5s19rjdmdg896 = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_7006y219sjdmdg89b.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_7006y219sjdmdg89b.toPt(px, precision);
  ...
  var $_345trk19tjdmdg89m = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_6j9w4v19qjdmdg893.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_53fdw519ujdmdg89q = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_6j9w4v19qjdmdg893.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_6j9w4v19qjdmdg893.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_2ojoge19vjdmdg89v = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_6f045q16njdmdg7vm.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_6f045q16njdmdg7vm.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_6f045q16njdmdg7vm.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_5glahn19wjdmdg89z = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_6j9w4v19qjdmdg893.postRenderFormat(editor, name),
        onclick: $_6j9w4v19qjdmdg893.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_6j9w4v19qjdmdg893.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_g05bmw19xjdmdg8a4 = { register: register$6 };
  ...
  var $_4zitp19yjdmdg8a7 = { register: register$7 };
  ...
  var $_79yq1y19zjdmdg8a9 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_ad7v9819mjdmdg88c.descendant($_g7pejy18pjdmdg84h.fromDom(document.body), editor.settings.ui_container).fold($_6f2mw816pjdmdg7vu.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_2ojoge19vjdmdg89v.register(editor);
    $_a483nn19pjdmdg890.register(editor);
    $_g05bmw19xjdmdg8a4.register(editor);
    $_4zitp19yjdmdg8a7.register(editor);
    $_345trk19tjdmdg89m.register(editor);
    $_6abs5s19rjdmdg896.register(editor);
    $_53fdw519ujdmdg89q.register(editor);
    $_79yq1y19zjdmdg8a9.register(editor);
    $_5glahn19wjdmdg89z.register(editor);
  };
  var $_ep72ys19ljdmdg887 = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_bn6vbe18xjdmdg85h.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_bn6vbe18xjdmdg85h.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_efev5d173jdmdg7xf,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_gbvw0t17gjdmdg7z4,
      Panel: Panel,
      Movable: $_8tyorj174jdmdg7xi,
      Resizable: $_71ay6z17hjdmdg7z6,
      ...
      FormatControls: $_ep72ys19ljdmdg887,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = Panel$1();
    $_ep72ys19ljdmdg887.setup(editor);
    $_8xfw2d17jjdmdg7za.addToEditor(editor, panel);
    return $_8a46v8161jdmdg7ud.get(editor, panel);
  });
  function Theme () {
  }
